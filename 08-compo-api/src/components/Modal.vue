<template>
    <div class="modal-background fade-in"
         @click.self="$emit('on:close')"> <!--el modificador de evento self sirve para que solo se haga el emmit al hacer click en el root element que lo emite-->
        <div class="modal-container">
            ...
            <!-- <slot>
                <div class="center">
                    Esto aparecerá si no se manda contenido
                </div>
            </slot> -->
        </div>
    </div>
